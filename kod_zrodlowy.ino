...
#define pinCS 10
#define spacer 1
int numberOfHorizontalDisplays = 3;// ilość wyświetlaczy 8x8
...
char inputString[1024]="Autor: Artur Bieniek";//napis, do którego wpisujemy wszystkie wyświetlane znaki
